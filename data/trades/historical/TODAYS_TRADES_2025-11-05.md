...
**DEE-BOT**: 0 approved / 5 rejected
**SHORGAN-BOT**: 0 approved / 5 rejected
...
|--------|--------|------------------|
| MRK | CLAUDE | Combined confidence 52.5% below threshold 60% |
| JNJ | CLAUDE | Combined confidence 52.5% below threshold 60% |
| PG | CLAUDE | Combined confidence 52.5% below threshold 60% |
| NEE | CLAUDE | Combined confidence 52.5% below threshold 60% |
| BRK.B | CLAUDE | Combined confidence 52.5% below threshold 60% |
...
| Symbol | Source | Rejection Reason |
|--------|--------|------------------|
| MRK | CLAUDE | Validation error: [Errno 22] Invalid argument |
| JNJ | CLAUDE | Combined confidence 52.5% below threshold 60% |
| PG | CLAUDE | Combined confidence 52.5% below threshold 60% |
| NEE | CLAUDE | Combined confidence 52.5% below threshold 60% |
| BRK.B | CLAUDE | Combined confidence 52.5% below threshold 60% |
