...
|--------|--------|-------------|------------|--------|
| BCRX | 38 | $6.63 | 56% | CLAUDE |
| NFLX | 3 | $85.25 | 56% | CLAUDE |
| NU | 5 | $18.15 | 56% | CLAUDE |


### BUY ORDERS
| Symbol | Shares | Limit Price | Stop Loss | Confidence | Source |
|--------|--------|-------------|-----------|------------|--------|
| AFRM | 3 | $67.50 | $62.00 | 56% | CLAUDE |
| PYPL | 4 | $56.00 | $52.50 | 56% | CLAUDE |
| LCID | 27 | $10.98 | $9.00 | 56% | CLAUDE |

### 📋 TRADE RATIONALE (Event-Driven Analysis)

**AFRM** - BUY
- **Catalyst**: Market catalyst (2026-02-06)
- **Rationale**: BNPL leader with earnings catalyst Feb 6 + oversold setup + score 7.0
- **Confidence**: 56% (External: 70%, Internal: 23%)

**PYPL** - BUY
- **Catalyst**: Market catalyst (2026-02-04)
- **Rationale**: Digital payments turnaround story at lows + Feb 4 earnings + 2.8:1 R/R
- **Confidence**: 56% (External: 70%, Internal: 23%)

**LCID** - BUY_TO_OPEN
- **Catalyst**: Market catalyst (2026-02-03)
- **Rationale**: Q4 delivery catalyst early Feb + normal IV + defined risk options play
- **Confidence**: 56% (External: 70%, Internal: 23%)
