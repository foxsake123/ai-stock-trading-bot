...
|--------|--------|-------------|------------|--------|
| PATH | 13 | $16.41 | 56% | CLAUDE |
| SAVA | 120 | $2.83 | 56% | CLAUDE |
| RIVN | 17 | $19.41 | 56% | CLAUDE |
| SMCI | 8 | $31.66 | 56% | CLAUDE |
| SOFI | 8 | $26.58 | 56% | CLAUDE |
| SRRK | 3 | $45.37 | 56% | CLAUDE |


### BUY ORDERS
| Symbol | Shares | Limit Price | Stop Loss | Confidence | Source |
|--------|--------|-------------|-----------|------------|--------|
| KPTI | 25 | $6.89 | $5.82 | 56% | CLAUDE |
| GME | 8 | $22.39 | $18.62 | 56% | CLAUDE |
...
|--------|--------|------------------|
| PLUG | CLAUDE | Already at max position weight (10.2% >= 10.0%) |
