...
**SHORGAN-BOT (LIVE)**: 0 approved / 10 rejected
...
|--------|--------|------------------|
| FDX | CLAUDE | Combined confidence 56.0% below threshold 65% |
| RIVN | CLAUDE | Combined confidence 56.0% below threshold 65% |
| NKE | CLAUDE | Catalyst date 2025-03-20 has already passed |
| SOFI | CLAUDE | Catalyst date 2025-02-04 has already passed |
| VKTX | CLAUDE | Catalyst date 2025-02-15 has already passed |
| BEAM | CLAUDE | Catalyst date 2025-01-13 has already passed |
| ROKU | CLAUDE | Catalyst date 2025-02-06 has already passed |
| MARA | CLAUDE | Catalyst date 2025-02-01 has already passed |
| AXSM | CLAUDE | Catalyst date 2025-02-15 has already passed |
| MARA | CLAUDE | Catalyst date 2025-02-01 has already passed |
