...
**SHORGAN-BOT (LIVE)**: 0 approved / 8 rejected
...
|--------|--------|------------------|
| SOFI | CLAUDE | Catalyst date 2025-01-28 has already passed |
| ROKU | CLAUDE | Catalyst date 2025-02-06 has already passed |
| VKTX | CLAUDE | Combined confidence 56.0% below threshold 65% |
| RIVN | CLAUDE | Catalyst date 2025-01-07 has already passed |
| PATH | CLAUDE | Catalyst date 2025-01-30 has already passed |
| SMCI | CLAUDE | Catalyst date 2025-01-15 has already passed |
| HOOD | CLAUDE | Catalyst date 2025-01-15 has already passed |
| QQQ | CLAUDE | Catalyst date 2025-01-10 has already passed |
