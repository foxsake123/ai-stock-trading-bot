...
|--------|--------|-------------|------------|--------|-----------|
| AAPL | 12 | $280.00 | 56% | CLAUDE | Reduce technology overweight and generate cash for rebalanci |
| BMY | 50 | $47.50 | 56% | CLAUDE | Trim healthcare sector concentration while maintaining core  |
| GILD | 40 | $122.00 | 56% | CLAUDE | Reduce outsized 14.3% position weight to portfolio maximum 1 |
| CVX | 30 | $148.00 | 56% | CLAUDE | Right-size energy exposure from 14.5% to under 10% target |

### BUY ORDERS
| Symbol | Shares | Limit Price | Stop Loss | Confidence | Source | Rationale |
|--------|--------|-------------|-----------|------------|--------|-----------|
| SO | 110 | $84.50 | $77.50 | 56% | CLAUDE | Add regulated utility exposure with 3.9% yield for defensive |
| T | 200 | $24.25 | $22.00 | 56% | CLAUDE | Deep value telecom with 7.1% yield and improving fundamental |

### REJECTED RECOMMENDATIONS (for transparency)
| Symbol | Source | Rejection Reason |
|--------|--------|------------------|
| UNH | CLAUDE | Invalid action: BUY TO COVER |
| KMB | CLAUDE | KMB not in S&P 100 (DEE-BOT only trades S&P 100 stocks) |
