...
|--------|--------|-------------|------------|--------|-----------|
| INTC | 50 | $46.90 | 56% | CLAUDE | Trim 26% gain per systematic profit-taking rules |
| PFE | 100 | $25.70 | 56% | CLAUDE | Exit underweight position with broken thesis |
| VZ | 100 | $38.90 | 56% | CLAUDE | Exit underweight telecom facing secular headwinds |

### BUY ORDERS
| Symbol | Shares | Limit Price | Stop Loss | Confidence | Source | Rationale |
|--------|--------|-------------|-----------|------------|--------|-----------|
| AAPL | 15 | $255.50 | $235.00 | 56% | CLAUDE | Add quality tech leader to reduce portfolio beta |
| KO | 55 | $70.45 | $64.75 | 56% | CLAUDE | Add defensive dividend aristocrat for stability |
